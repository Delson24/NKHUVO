...
import { Menu, X, Calendar, User, Search, LogOut, PlusCircle, LayoutDashboard, ShieldCheck, Instagram, Facebook } from 'lucide-react';
...
export const Navbar: React.FC<LayoutProps> = ({ user, onLogout, onNavigate }) => {
  ...
  const NavLink = ({ path, label, icon: Icon, primary = false }: any) => (
    <button
      ...
      className={`flex items-center space-x-2 px-5 py-2.5 rounded-full transition-all duration-300 text-sm font-medium ${primary
      ...
      <div className="grid md:grid-cols-12 gap-12 mb-16">
        <div className="md:col-span-5">
          ...
          <div className="flex gap-4">
            {/* Instagram */}
            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center hover:bg-pink-600 hover:border-pink-600 hover:text-white transition-all cursor-pointer group">
              <Instagram size={18} />
            </a>

            {/* TikTok - Custom SVG to match Lucide style */}
            <a href="https://tiktok.com" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center hover:bg-black hover:border-slate-600 hover:text-white transition-all cursor-pointer group">
            ...
            {/* Facebook */}
            <a href="https://facebook.com" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center hover:bg-blue-600 hover:border-blue-600 hover:text-white transition-all cursor-pointer group">
              <Facebook size={18} />
            </a>
          </div>
        </div>
